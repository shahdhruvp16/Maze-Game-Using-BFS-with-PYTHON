...
def BFS(m, start=None):
    ...
    covered_blocks = len(bSearch)
    
    return bSearch, bfsPath, fwdPath, shortest_path_length, covered_blocks

if __name__ == '__main__':
    m = maze(12, 10)
    m.CreateMaze(loopPercent=10, theme='light')
    bSearch, bfsPath, fwdPath, shortest_path_length, covered_blocks = BFS(m)
